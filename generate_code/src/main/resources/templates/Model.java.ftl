...
<#if columns??>
    <#list columns as column>
        <#if column.type ='VARCHAR' || column.type = 'TEXT' || column = 'CHAR'>
            /**
            *${column.remark}
            */
...
<#if columns??>
    <#list columns as column>
        <#if column.type ='VARCHAR' || column.type = 'TEXT' || column = 'CHAR'>
            ...
            public void set${column.propertyName}(String ${column.propertyName}) {
                this.${column.propertyName?uncap_first} = ${column.propertyName};
            }
